...
<head>
    ...
    <link rel="icon" href="Img PagConsultas/Industrias-CORP-S.A-removebg-preview.png" >
    <link rel="stylesheet" type="text/css" href="Styles.css">
</head> 
<body>
<img src="Img PagConsultas/Industrias CORP S.A.jpg" alt="MiLogo">    
<h1>Consultas   </h1>
...
<div class="Formulario">    
    ...
    <label for="text" style="font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">Ingrese su Consulta
        <textarea name="text" id="text" cols="40" rows="10" required></textarea>
    </label>
    <input type="submit">
    </form>
